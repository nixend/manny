...
import com.nixend.manny.admin.model.dto.BaseDTO;
...
import static com.nixend.manny.admin.utils.Constants.COLON;
...
public class ConvertUtil {
    ...
    public static String getScopeFromDTO(BaseDTO baseDTO) {
        if (StringUtils.isNotEmpty(baseDTO.getApplication())) {
            return com.nixend.manny.admin.utils.Constants.APPLICATION;
        } else {
            return com.nixend.manny.admin.utils.Constants.SERVICE;
        }
    }
